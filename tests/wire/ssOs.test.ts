...
describe("SsOsClient", () => {
    test("list (1)", async () => {
        ...
        const response = await client.ssOs.list();
    ...
    test("retrieve (1)", async () => {
        ...
        const response = await client.ssOs.retrieve({
            id: "id",
        });
        expect(response).toEqual({
            data: {
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.ssOs.retrieve({
                id: "id",
            });
        }).rejects.toThrow(Forum.UnauthorizedError);
    });
    ...
    test("delete (1)", async () => {
        ...
        const response = await client.ssOs.delete({
            id: "id",
        });
        expect(response).toEqual({
            data: {
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.ssOs.delete({
                id: "id",
            });
        }).rejects.toThrow(Forum.UnauthorizedError);
    });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.ssOs.update({
            id: "id",
        });
        expect(response).toEqual({
            data: {
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.ssOs.update({
                id: "id",
            });
        }).rejects.toThrow(Forum.BadRequestError);
    });
